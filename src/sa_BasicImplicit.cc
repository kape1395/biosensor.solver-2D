...
#ifdef TODO_REMOVE_ME
/* ************************************************************************** */
/* ************************************************************************** */
/**
 *  Konstruktorius.
 */
sa::basicimplicit::Solver::Solver(
    cfg::Config* config,
 ...
 */
void sa::basicimplicit::Solver::solve()
{
    std::cout << "sa::basicimplicit::Solver::solve()...\n";
    ...
    std::cout << "sa::basicimplicit::Solver::solve()... Done\n";
}
 ...
 */
void sa::basicimplicit::Solver::solveIteration()
{
    //std::cout << "sa::basicimplicit::Solver::solveIteration()...\n";
    ...
    //std::cout << "sa::basicimplicit::Solver::solveIteration()... Done\n";
}
 ...
 *  Konstruktorius.
 */
sa::basicimplicit::AreaSolver::AreaSolver(Solver* solver, dm::Area *data)
{
 ...
 *  Destruktorius.
 */
sa::basicimplicit::AreaSolver::~AreaSolver()
{
#ifdef AreaSolver_DIFFUSION_V1
 ...
 */
void sa::basicimplicit::AreaSolver::solveIteration()
{
...
sa::basicimplicit::AreaSolver::Diffusion::Diffusion(int sIndex, double coef)
{
    this->substanceIndex = sIndex;
    this->coefficient    = coef;
}
inline void sa::basicimplicit::AreaSolver::Diffusion::apply(
...
sa::basicimplicit::AreaSolver::Reaction::Reaction(int sIndex, int pIndex, double V_max, double K_M)
{
...
inline void sa::basicimplicit::AreaSolver::Reaction::apply(double*& source, double*& target, double& dt)
{
 ...
 */
sa::basicimplicit::BoundSolver::BoundSolver(Solver* solver, dm::Bound* data)
{
    this->solver = solver;
    this->data   = data;
 ...
 */
sa::basicimplicit::BoundSolver::~BoundSolver()
{
 ...
 */
void sa::basicimplicit::BoundSolver::solveIteration()
{
...
sa::basicimplicit::BoundSolver::Condition::Condition(int substanceIndex)
{
    this->substanceIndex = substanceIndex;
}
sa::basicimplicit::BoundSolver::Condition::~Condition()
{}


sa::basicimplicit::BoundSolver::WallCondition::WallCondition(
    int                    substanceIndex,
...
sa::basicimplicit::BoundSolver::WallCondition::~WallCondition()
{}
void sa::basicimplicit::BoundSolver::WallCondition::apply(dm::Bound* data)
{
 ...
 *
 */
sa::basicimplicit::BoundSolver::MergeCondition::MergeCondition(
    int                         substanceIndex,
 ...
 *
 */
void sa::basicimplicit::BoundSolver::MergeCondition::apply(dm::Bound* data)
{
 ...
 *
 */
sa::basicimplicit::BoundSolver::ConstCondition::ConstCondition(
 ...
 *
 */
void sa::basicimplicit::BoundSolver::ConstCondition::apply(dm::Bound* data)
{
 ...
 */
void sa::basicimplicit::CornerSolver::solveIteration()
{
